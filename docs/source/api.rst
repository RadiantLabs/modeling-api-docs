...
.. literalinclude:: schemas/request/BaseBuilding.json5
   ...
   +------------------------+-------+--------+-----------+--------+------------------+----------------------------------------------+
   |Property                |Type   |Units   |Constraints|Required|   Informed By    |Notes                                         |
   |                        |       |        |           |        +----+----+--------+                                              |
   |                        |       |        |           |        |RLPD|BSA |Other   |                                              |
   +========================+=======+========+===========+========+====+====+========+==============================================+
   |``conditionedFloorArea``|integer|ft2     |>0         |no      |yes |no  |no      |If missing from RLPD, model will fail         |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``averageCeilingHeight``|integer|ft      |>0         |no      |no	|no  |8       |                                              |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``bathCount``           |integer|count   |>0         |no      |yes |no  |see [#]_|                                              |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``bedroomsCount``       |integer|count   |>0         |no      |yes |yes |no      |                                              |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``residentCount``       |integer|count   |>=0        |no      |no  |yes |no      |                                              |	
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``storiesCount``        |integer|count   |>0         |no      |yes |yes |no      |                                              |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``windowToWallFraction``|float  |fraction|>0         |no      |no  |no  |0.14    |                                              |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
   |``yearBuilt``           |integer|year    |>1600      |no      |yes |no  |no      |If missing from RLPD, model will fail         |
   +------------------------+-------+--------+-----------+--------+----+----+--------+----------------------------------------------+
